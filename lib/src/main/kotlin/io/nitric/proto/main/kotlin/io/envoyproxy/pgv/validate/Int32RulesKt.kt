...
inline fun int32Rules(block: io.envoyproxy.pgv.validate.Int32RulesKt.Dsl.() -> kotlin.Unit): io.envoyproxy.pgv.validate.Validate.Int32Rules =
  io.envoyproxy.pgv.validate.Int32RulesKt.Dsl._create(io.envoyproxy.pgv.validate.Validate.Int32Rules.newBuilder()).apply { block() }._build()
object Int32RulesKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    private val _builder: io.envoyproxy.pgv.validate.Validate.Int32Rules.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: io.envoyproxy.pgv.validate.Validate.Int32Rules.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): io.envoyproxy.pgv.validate.Validate.Int32Rules = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun io.envoyproxy.pgv.validate.Validate.Int32Rules.copy(block: io.envoyproxy.pgv.validate.Int32RulesKt.Dsl.() -> kotlin.Unit): io.envoyproxy.pgv.validate.Validate.Int32Rules =
  io.envoyproxy.pgv.validate.Int32RulesKt.Dsl._create(this.toBuilder()).apply { block() }._build()
