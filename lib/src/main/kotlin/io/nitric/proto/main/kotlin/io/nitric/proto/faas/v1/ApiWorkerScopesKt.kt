...
@kotlin.jvm.JvmName("-initializeapiWorkerScopes")
inline fun apiWorkerScopes(block: io.nitric.proto.faas.v1.ApiWorkerScopesKt.Dsl.() -> kotlin.Unit): io.nitric.proto.faas.v1.ApiWorkerScopes =
  io.nitric.proto.faas.v1.ApiWorkerScopesKt.Dsl._create(io.nitric.proto.faas.v1.ApiWorkerScopes.newBuilder()).apply { block() }._build()
object ApiWorkerScopesKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    private val _builder: io.nitric.proto.faas.v1.ApiWorkerScopes.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: io.nitric.proto.faas.v1.ApiWorkerScopes.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): io.nitric.proto.faas.v1.ApiWorkerScopes = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun io.nitric.proto.faas.v1.ApiWorkerScopes.copy(block: io.nitric.proto.faas.v1.ApiWorkerScopesKt.Dsl.() -> kotlin.Unit): io.nitric.proto.faas.v1.ApiWorkerScopes =
  io.nitric.proto.faas.v1.ApiWorkerScopesKt.Dsl._create(this.toBuilder()).apply { block() }._build()
